...
<head>
    ...
    <style>
        #logo {
            ...
            max-width: 60%;
            /* largeur maximale de l'image, sans dépasser 100% du conteneur */
            max-height: 60px;
            /* hauteur maximale pour l'image */
            width: auto;
            /* garde la largeur proportionnelle */
        }
    </style>
</head>
    ...
    <nav
        ...
        <div class="container">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="#">
                <img src="{{asset('assets/img/logo_finpla.png')}}" class="navbar-brand-img h-100"
                alt="main_logo" id="logo">
                FinPlan
            </a>
                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a href="https://www.creative-tim.com/product/soft-ui-dashboard"
                            class="btn btn-sm btn-round mb-0 me-1 bg-gradient-light">Get to know us more</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main class="main-content  mt-0">
        <section class="min-vh-100 mb-8">
            <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
                style="background-image: url('../assets/img/curved-images/curved24.jpg');">
                <span class="mask bg-gradient-dark opacity-6"></span>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                            <p class="text-lead text-white">Connected you and become the master of your finances</p>
                        </div>
                    </div>
                </div>
            </div>
